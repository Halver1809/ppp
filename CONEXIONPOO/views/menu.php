...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/cargo.css">
...
<body>
    <form action="../controller/registrarCargo.php" method="POST" class="form-box">
        <div class="text-center">
            ...
            <br>
            <br>
            <h1 class="Form-tittle">Bienvenido</h1>
        </div>
        <div>

            <br>
            <div class="text-center d-grid gap-2">
                <a href="empleado.php" class="btn btn-dark">Empleado</a>
            </div>
            <br>
            <br>
            <div class="text-center d-grid gap-2">
                <a href="usuario.php" class="btn btn-dark">Usuario</a>
            </div>
            <br>
            <br>
            <div class="text-center d-grid gap-2">
                <a href="cargo.php" class="btn btn-dark">cargo</a>
            </div>
            <br>
        </div>
