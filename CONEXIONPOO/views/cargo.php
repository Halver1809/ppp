...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/cargo.css?20232505">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-aFq/bzH65dt+w6FI2ooMVUpc+21e0SRygnTpmBvdBgSdnuTN7QbdgL+OapgHtvPp" crossorigin="anonymous">

</head>

<body>
    <form action="../controller/registrarCargo.php" method="POST" class="form-box">
        <div class="row">
            <div class="col-6">
            ...
            <div class="col-6 editar">
                <a href="empleado.php" class="btn ">Formulario</a>
        ...
        <div class="text-center clas">
            ...
            <div class="text-center">
                ...
                <br>
                <br>
                <h1 class="Form-tittle">Registro de cargo</h1>
            </div>
            <div>

                <br>
                <label class="form-title3">Nombre del cargo</label>
                <input placeholder="Porfavor ingrese un cargo" type="text" class="form-control" required placeholder="" name="nombre">
                <br>
                <label class="form-title3">Sueldo del cargo</label>
                <input placeholder="Porfavor ingrese el sueldo" type="number" class="form-control" required placeholder="" name="sueldo">
                <br>
